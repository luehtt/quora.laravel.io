...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header bg-success border-success">
            <div><a class="mr-2" href="?view=views">Lượt xem</a>
            <a class="mr-2" href="?view=replies">Lượt thảo luận</a>
            <a class="mr-2" href="?view=latest">Mới nhất</a>
            <a class="mr-2" href="?view=updated">Mới cập nhật</a></div>
        </div>
    </div>
